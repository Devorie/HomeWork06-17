...
const RecipeCard = ({ title, category, ingredients, steps, share, imageUrl }) => {
        ...
        < div className="card shadow-sm h-100" style={{ borderRadius: '15px' }}>
            < div className="card-body d-flex flex-column" style={{ maxHeight: '500px', overflow: 'hidden' }}>
                ...
                {imageUrl && (
                        ...
                        < img src={imageUrl}
                    alt = "Recipe Preview" className = "img-fluid" style ={{ width: '150px', height: '150px', borderRadius: '10px', objectFit: 'cover' }} />
            </ div >
                )}
            < div style={{ flex: '1 1 auto', overflowY: 'auto' }}>
                ...
                < div className="mb-2" >
                    ...
                    < p >
                        ...
                        {share ? < FaUserAlt style={{ color: '#28a745' }} /> : < FaUserAlt style={{ color: '#dc3545' }} />}
                    </ p >
            </ div >
        </ div >
        </ div >
